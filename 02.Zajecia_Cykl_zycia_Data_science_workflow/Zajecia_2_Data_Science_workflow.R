...
#4.1 Najczęściej używane funkcje pakietu dplyr: ----
...
#4.1.1 mutate() – tworzenie nowych zmiennych na bazie istniejących ----
...
#4.1.6 summarise() - obliczanie wartości zagregowanych (np. średnich, sum) ----
